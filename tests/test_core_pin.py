...
def stub_core(tmp_path: Path, *, name: str, init_body: str = "",
    ...
    if pin_body is not None:
        # `pin.py` is the module this package imports since 2026-07-27; the
        # `_pin.py` alias is written too, because a real core carries both and
        # a stub that carries one is a shape no install has.
