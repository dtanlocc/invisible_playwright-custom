...
description: "Force specific fingerprint fields like GPU or screen size while leaving the rest seed-derived. Control what stays random and what stays fixed."
